...
class MedZone_Lite_Dashboard_Setup {
	...
	public function get_steps() {
		return array(
			...
			array(
				'id'       => 'enjoy',
				'title'    => __( 'Almost ready', 'medzone-lite' ),
				'content'  => array(
					'paragraphs' => array(
						...
						__( 'Allow MachoThemes to track theme usage.', 'medzone-lite' ),
				...
				'buttons'  => array(
					'next' => array(
						'action' => 'customizer',
						'label'  => __( 'Allow & Finish', 'medzone-lite' ),
					),
				),
			),
		);
		...
		to hide all upsells & recommended plugin discovery sections & actions.', 'medzone-lite' ) ),
				...
				'fields'  => array(
					...
					array(
						...
						'value'   => true,
						'label'   => esc_html__( 'Allow Theme Tracking', 'medzone-lite' ),
						'type'    => 'epsilon-toggle',
